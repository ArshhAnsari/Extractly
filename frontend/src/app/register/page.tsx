...
import { registerSchema } from '@/lib/validators/jobSchemas';
    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 sm:p-6 relative overflow-hidden">
      ...
      >
        <div className="text-center space-y-3 mb-8">
          ...
          <h2 className="text-3xl font-bold font-heading tracking-tight text-foreground">Create an account</h2>
          <p className="text-sm text-muted-foreground">Start extracting data in seconds</p>
        </div>
        ...
        <form onSubmit={registerForm.handleSubmit(onRegister)} className="space-y-6">
          <div className="space-y-2">
            <Label htmlFor="fullName" className="text-[10px] uppercase tracking-widest text-muted-foreground font-bold">
              Name
            </Label>
            <Input
              id="fullName"
        ...
        <div className="mt-8 text-center text-sm text-muted-foreground">
          ...
          <Link href="/login" className="text-primary hover:text-primary-hover hover:underline font-semibold transition-colors">
            Sign in here
          </Link>
        </div>
      </motion.div>
